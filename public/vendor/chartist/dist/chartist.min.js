...
!(function (a, b) {
    ...
    return (
        (function (a, b) {
            ...
            var c = a.window,
                d = a.document;
            (b.namespaces = { svg: "http://www.w3.org/2000/svg", xmlns: "http://www.w3.org/2000/xmlns/", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", ct: "http://gionkunz.github.com/chartist-js/ct" }),
                (b.noop = function (a) {
                    return a;
                }),
                ...
                (b.normalizePadding = function (a, b) {
                    return (
                        ...
                        "number" == typeof a
                            ...
                            : { top: "number" == typeof a.top ? a.top : b, right: "number" == typeof a.right ? a.right : b, bottom: "number" == typeof a.bottom ? a.bottom : b, left: "number" == typeof a.left ? a.left : b }
                    );
                }),
                ...
                (b.getHighLow = function (a, c, d) {
                    ...
                    var f = { high: void 0 === c.high ? -Number.MAX_VALUE : +c.high, low: void 0 === c.low ? Number.MAX_VALUE : +c.low },
                        g = void 0 === c.high,
                        h = void 0 === c.low;
                    return (
                        (g || h) && e(a),
                        (c.referenceValue || 0 === c.referenceValue) && ((f.high = Math.max(c.referenceValue, f.high)), (f.low = Math.min(c.referenceValue, f.low))),
                        f.high <= f.low && (0 === f.low ? (f.high = 1) : f.low < 0 ? (f.high = 0) : f.high > 0 ? (f.low = 0) : ((f.high = 1), (f.low = 0))),
                        f
                    );
                }),
                ...
                (b.createChartRect = function (a, c, d) {
                    ...
                    return (
                        e
                            ? ("start" === c.axisX.position ? ((k.y2 = j.top + g), (k.y1 = Math.max(i - j.bottom, k.y2 + 1))) : ((k.y2 = j.top), (k.y1 = Math.max(i - j.bottom - g, k.y2 + 1))),
                              "start" === c.axisY.position ? ((k.x1 = j.left + f), (k.x2 = Math.max(h - j.right, k.x1 + 1))) : ((k.x1 = j.left), (k.x2 = Math.max(h - j.right - f, k.x1 + 1))))
                            ...
                            if (f.length) {
                                ...
                                for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++)
                                    0 === n[h] || 0 === n[h - 1] || n[h - 1] > 0 != n[h] > 0
                                        ? (m[h] = 0)
                                        : ((m[h] = (3 * (p[h - 1] + p[h])) / ((2 * p[h] + p[h - 1]) / n[h - 1] + (p[h] + 2 * p[h - 1]) / n[h])), isFinite(m[h]) || (m[h] = 0));
        ...
        (function (a, b) {
            ...
            function c(a, c, d) {
                return (
                    a && ((this.data = a || {}), (this.data.labels = this.data.labels || []), (this.data.series = this.data.series || []), this.eventEmitter.emit("data", { type: "update", data: this.data })),
                    c &&
                        ((this.options = b.extend({}, d ? this.options : this.defaultOptions, c)),
                        this.initializeTimeoutId || (this.optionsProvider.removeMediaQueryListeners(), (this.optionsProvider = b.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)))),
        ...
        (function (a, b) {
            ...
            function c(a, c, d, e, f) {
                a instanceof Element ? (this._node = a) : ((this._node = y.createElementNS(b.namespaces.svg, a)), "svg" === a && this.attr({ "xmlns:ct": b.namespaces.ct })),
                    c && this.attr(c),
                    d && this.addClass(d),
                    e && (f && e._node.firstChild ? e._node.insertBefore(this._node, e._node.firstChild) : e._node.appendChild(this._node));
            }
            function d(a, c) {
                        ...
                        function (e) {
                            function f(a, c) {
                                ...
                                a.easing && ((h = a.easing instanceof Array ? a.easing : b.Svg.Easing[a.easing]), delete a.easing),
                                    ...
                                    c && ((a.fill = "freeze"), (i[e] = a.from), this.attr(i), (g = b.quantity(a.begin || 0).value), (a.begin = "indefinite")),
                                    ...
                                    f._node.addEventListener(
                                        "endEvent",
                                        function () {
                                            d && d.emit("animationEnd", { element: this, animate: f._node, params: a }), c && ((i[e] = a.to), this.attr(i), f.remove());
                                        }.bind(this)
                                    );
                            }
        ...
        (function (a, b) {
            ...
            function k(a, b, d, e, f, g, h, i, j) {
                return c("A", { rx: +a, ry: +b, xAr: +d, lAf: +e, sf: +f, x: +g, y: +h }, this.pathElements, this.pos++, i, j), this;
            }
            function l(a) {
                var c = a
            ...
            var t = { m: ["x", "y"], l: ["x", "y"], c: ["x1", "y1", "x2", "y2", "x", "y"], a: ["rx", "ry", "xAr", "lAf", "sf", "x", "y"] },
                u = { accuracy: 3 };
            (b.Svg.Path = b.Class.extend({ constructor: e, position: f, remove: g, move: h, line: i, curve: j, arc: k, scale: n, translate: o, transform: p, parse: l, stringify: m, clone: q, splitByCommand: r })),
                            ...
                            (b.isFalseyButZero(i[k]) && "" !== i[k]) ||
                                ("x" === this.units.pos
                                    ? ((j = this.chartRect.x1 + j),
                                      ...
                                      "start" === e.axisX.position ? (m.y = this.chartRect.padding.top + e.axisX.labelOffset.y + (d ? 5 : 20)) : (m.y = this.chartRect.y1 + e.axisX.labelOffset.y + (d ? 5 : 20)))
                                    : ((j = this.chartRect.y1 - j),
                                      (m.y = e.axisY.labelOffset.y - (d ? l : 0)),
                                      "start" === e.axisY.position ? (m.x = d ? this.chartRect.padding.left + e.axisY.labelOffset.x : this.chartRect.x1 - 10) : (m.x = this.chartRect.x2 + e.axisY.labelOffset.x + 10)),
                                g.showGrid && b.createGrid(j, k, this, this.gridOffset, this.chartRect[this.counterUnits.len](), a, [e.classNames.grid, e.classNames[this.units.dir]], f),
                                g.showLabel && b.createLabel(j, l, k, i, this, g.offset, m, c, [e.classNames.label, e.classNames[this.units.dir], "start" === g.position ? e.classNames[g.position] : e.classNames.end], d, f));
                    }.bind(this)
                );
            }
            var e =
                (a.window,
                a.document,
                { x: { pos: "x", len: "width", dir: "horizontal", rectStart: "x1", rectEnd: "x2", rectOffset: "y2" }, y: { pos: "y", len: "height", dir: "vertical", rectStart: "y2", rectEnd: "y1", rectOffset: "x1" } });
        ...
        (function (a, b) {
            ...
            function c(a) {
                ...
                (d =
                    void 0 === a.axisX.type
                        ? new b.StepAxis(b.Axis.units.x, c.normalized.series, j, b.extend({}, a.axisX, { ticks: c.normalized.labels, stretch: a.fullWidth }))
                        : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, j, a.axisX)),
                    (f =
                        void 0 === a.axisY.type
                            ? new b.AutoScaleAxis(b.Axis.units.y, c.normalized.series, j, b.extend({}, a.axisY, { high: b.isNumeric(a.high) ? a.high : a.axisY.high, low: b.isNumeric(a.low) ? a.low : a.axisY.low }))
                    ...
                    c.raw.series.forEach(
                        function (e, g) {
                            var i = h.elem("g");
                            i.attr({ "ct:series-name": e.name, "ct:meta": b.serialize(e.meta) }), i.addClass([a.classNames.series, e.className || a.classNames.series + "-" + b.alphaNumerate(g)].join(" "));
                            var k = [],
                                l = [];
                            c.normalized.series[g].forEach(
                                function (a, h) {
                                    var i = { x: j.x1 + d.projectValue(a, h, c.normalized.series[g]), y: j.y1 - f.projectValue(a, h, c.normalized.series[g]) };
                            ...
                            if (
                                (m.showPoint &&
                                    o.pathElements.forEach(
                                        function (c) {
                                            var h = i
                                                .elem("line", { x1: c.x, y1: c.y, x2: c.x + 0.01, y2: c.y }, a.classNames.point)
                                                .attr({ "ct:value": [c.data.value.x, c.data.value.y].filter(b.isNumeric).join(","), "ct:meta": b.serialize(c.data.meta) });
                                ...
                                o.splitByCommand("M")
                                    ...
                                    .forEach(
                                        function (b) {
                                            ...
                                            this.eventEmitter.emit("draw", { type: "area", values: c.normalized.series[g], path: b.clone(), series: e, seriesIndex: g, axisX: d, axisY: f, chartRect: j, index: g, group: i, element: h });
                                        }.bind(this)
                                    );
                            }
                        }.bind(this)
            ...
            var e =
                ...
                a.document,
                {
                    axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: b.noop, type: void 0 },
                    axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: b.noop, type: void 0, scaleMinSpace: 20, onlyInteger: !1 },
                    width: void 0,
                    height: void 0,
                    showLine: !0,
                    showPoint: !0,
        ...
        (function (a, b) {
            ...
            function c(a) {
                ...
                (k = a.distributeSeries && a.stackBars ? c.normalized.labels.slice(0, 1) : c.normalized.labels),
                    a.horizontalBars
                        ? ((j = m =
                              void 0 === a.axisX.type
                                  ? new b.AutoScaleAxis(b.Axis.units.x, c.normalized.series, o, b.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))
                                  : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, o, b.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))),
                          (l = n = void 0 === a.axisY.type ? new b.StepAxis(b.Axis.units.y, c.normalized.series, o, { ticks: k }) : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, o, a.axisY)))
                        : ((l = m = void 0 === a.axisX.type ? new b.StepAxis(b.Axis.units.x, c.normalized.series, o, { ticks: k }) : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, o, a.axisX)),
                          (j = n =
                              void 0 === a.axisY.type
                                  ? new b.AutoScaleAxis(b.Axis.units.y, c.normalized.series, o, b.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))
                                  : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, o, b.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))));
                ...
                l.createGridAndLabels(f, h, this.supportsForeignObject, a, this.eventEmitter),
                    ...
                    c.raw.series.forEach(
                        function (d, e) {
                            ...
                            (f = a.distributeSeries && !a.stackBars ? l.axisLength / c.normalized.series.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / c.normalized.series[e].length / 2),
                                (h = g.elem("g")),
                                h.attr({ "ct:series-name": d.name, "ct:meta": b.serialize(d.meta) }),
                                h.addClass([a.classNames.series, d.className || a.classNames.series + "-" + b.alphaNumerate(e)].join(" ")),
                                c.normalized.series[e].forEach(
                                    function (g, k) {
                                        ...
                                        if (
                                            ...
                                            (r = a.horizontalBars
                                                ? { x: o.x1 + j.projectValue(g && g.x ? g.x : 0, k, c.normalized.series[e]), y: o.y1 - l.projectValue(g && g.y ? g.y : 0, u, c.normalized.series[e]) }
                                                : { x: o.x1 + l.projectValue(g && g.x ? g.x : 0, u, c.normalized.series[e]), y: o.y1 - j.projectValue(g && g.y ? g.y : 0, k, c.normalized.series[e]) }),
                                            l instanceof b.StepAxis &&
                                                (l.options.stretch || (r[l.units.pos] += f * (a.horizontalBars ? -1 : 1)), (r[l.units.pos] += a.stackBars || a.distributeSeries ? 0 : i * a.seriesBarDistance * (a.horizontalBars ? -1 : 1))),
                                            (t = q[k] || p),
                                            ...
                                            (s = h.elem("line", v, a.classNames.bar).attr({ "ct:value": [g.x, g.y].filter(b.isNumeric).join(","), "ct:meta": b.serialize(w) })),
                                                this.eventEmitter.emit("draw", b.extend({ type: "bar", value: g, index: k, meta: w, series: d, seriesIndex: e, axisX: m, axisY: n, chartRect: o, group: h, element: s }, v));
                                        }
                                    }.bind(this)
                                );
                        }.bind(this)
            ...
            var e =
                ...
                a.document,
                {
                    axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: b.noop, scaleMinSpace: 30, onlyInteger: !1 },
                    axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: b.noop, scaleMinSpace: 20, onlyInteger: !1 },
                    width: void 0,
                    height: void 0,
                    high: void 0,
                    low: void 0,
        ...
        (function (a, b) {
            ...
            function d(a) {
                var d,
                    ...
                    k = [],
                    l = a.startAngle;
                (this.svg = b.createSvg(this.container, a.width, a.height, a.donut ? a.classNames.chartDonut : a.classNames.chartPie)),
                ...
                "%" === m.unit && (m.value *= g / 100),
                    ...
                    (h = "outside" === a.labelPosition || (a.donut && !a.donutSolid) ? g : "center" === a.labelPosition ? 0 : a.donutSolid ? g - m.value / 2 : g / 2),
                    (h += a.labelOffset);
                    ...
                    j.raw.series.forEach(
                        function (e, f) {
                            if (0 !== j.normalized.series[f] || !a.ignoreEmptyValues) {
                                ...
                                a.donut
                                    ? a.donutSolid &&
                                      ((t = g - m.value), (r = b.polarToCartesian(n.x, n.y, t, l - (0 === f || o ? 0 : 0.2))), (s = b.polarToCartesian(n.x, n.y, t, p)), w.line(r.x, r.y), w.arc(t, t, 0, p - l > 180, 1, s.x, s.y))
                                    : w.line(n.x, n.y);
                                ...
                                if (
                                    ...
                                    if (B || 0 === B) {
                                        var C = d.elem("text", { dx: z.x, dy: z.y, "text-anchor": c(n, z, a.labelDirection) }, a.classNames.label).text("" + B);
                                        this.eventEmitter.emit("draw", { type: "label", index: f, group: d, element: C, text: "" + B, x: z.x, y: z.y });
                                    }
                                }
                                l = p;
                            }
